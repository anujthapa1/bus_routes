        ...
        <div className="relative flex-1 flex flex-col lg:ml-64">
          ...
          <div className="relative flex-1 bg-slate-200 dark:bg-slate-900 overflow-hidden">
            ...
            >
              ...
              {/* Map Markers */}
              <div className="absolute top-1/4 left-1/3 p-2 bg-white dark:bg-slate-900 rounded-full shadow-xl border-4 border-primary ring-4 ring-primary/20">
                <span className="material-symbols-outlined text-primary">directions_bus</span>
              </div>
              <div className="absolute bottom-1/3 right-1/4 p-2 bg-white dark:bg-slate-900 rounded-full shadow-xl border-4 border-slate-400 ring-4 ring-slate-400/20">
